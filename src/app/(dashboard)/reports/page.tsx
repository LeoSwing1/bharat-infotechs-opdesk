export default function Page(){
 return <div><div className="mb-8"><h1 className="text-3xl font-bold">Reports</h1><p className="text-gray-500 mt-1">Operational reporting for people, teams, tasks and attendance.</p></div>
 <div className="card p-8"><div className="text-lg font-semibold">Reports workspace</div><p className="text-gray-500 mt-2">The data model and service layer are connected. Use this workspace as the management surface for reports.</p>
